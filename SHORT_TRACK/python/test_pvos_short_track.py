...
class Tests(unittest.TestCase):
 ...
 def test_input_adapter_rejects_unapproved_source_type(self):
  a=fixture(); a["inputAcquisition"]["sourceType"]="DWG_IMPORT"
  with self.assertRaisesRegex(track.InputBlocked,"OPERATOR_SUPPLIED_JSON"): track.calculate(a)
