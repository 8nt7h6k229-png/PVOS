...
| GAP-017 | PVOS has no governed Engineering Input Acquisition method. No CAD-to-JSON, DXF Import, DWG Import, or existing real-project input pipeline is established. The C# CLI constructs source-defined input and existing JSON is static evidence only. | [`PRODUCT/PVOS_RUNTIME_WORKFLOW.md`](../PRODUCT/PVOS_RUNTIME_WORKFLOW.md), [`PRODUCT/PVOS_RUNTIME_INPUT_CONTRACT.md`](../PRODUCT/PVOS_RUNTIME_INPUT_CONTRACT.md), [`ENGINEERING/ENG-001_IMPLEMENTATION_NOTES.md`](../ENGINEERING/ENG-001_IMPLEMENTATION_NOTES.md), [`PM/PRODUCT_KNOWLEDGE_INDEX.md`](PRODUCT_KNOWLEDGE_INDEX.md) | An engineer cannot supply real project geometry to the bounded Runtime without a separately governed acquisition boundary. | Experimental Short-Track adapter and future PM architecture/product disposition; no automatic Product promotion |
